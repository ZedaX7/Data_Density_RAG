"""
Hybrid Retrieval for Battery Pack RAG System

This module implements a hybrid retrieval approach combining:
1. Numerical constraint filtering (hard constraints from query)
2. Feature-based distance scoring (weighted normalized feature distance)
3. Dense embedding similarity (semantic similarity via BGE embeddings)

The final score combines these approaches for optimal retrieval of
battery pack designs that match both semantic intent and numerical specs.
"""
